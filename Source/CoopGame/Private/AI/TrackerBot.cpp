...
void ATrackerBot::HandleTakeDamage(UHealth* OwningHealthComp, float Health, float HealthDelta, const class UDamageType* DamageType, class AController* InstigatedBy, AActor* DamageCauser)
{
	if (MatInst == nullptr)
	{
...
FVector ATrackerBot::GetNextPathPoint()
{
	...
	for (FConstPawnIterator It = GetWorld()->GetPawnIterator(); It; ++It)
	{
		...
		if (TestPawn == nullptr || UHealth::IsFriendly(TestPawn, this))
		{
			continue;
		}

		UHealth* TestPawnHealthComp = Cast<UHealth>(TestPawn->GetComponentByClass(UHealth::StaticClass()));
...
void ATrackerBot::NotifyActorBeginOverlap(AActor* OtherActor)
{
	...
	if (!bStartedSelfDestruction && !bExploded)
	{
		...
		if (PlayerPawn && !UHealth::IsFriendly(OtherActor, this))
		{
